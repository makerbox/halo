 ...
 */
registerBlockType( 'cgb/block-stat', {
	...
	edit: ( {attributes, setAttributes} ) => {
		...
		const changeLabel = (newText) => {
			setAttributes({
				label: newText
			})
		};
		const changeSubLabel = (newText) => {
			setAttributes({
				subLabel: newText
			})
		};
		return (
			<div className="c-stat">
				<div className="c-stat__glyph">
					<MediaUpload 
			            onSelect={changeGlyph}
			            render={
			            	({open}) => {
				...
				<div className="c-stat__stat">
					<RichText
						className="c-stat__stat--richtext"
						onChange={changeStat}
				...
				<div className="c-stat__sub-label">
					<RichText
						className="c-stat__stat--richtext"
						onChange={changeSubLabel}
						value={attributes.subLabel}
					/>
				</div>
			</div>
		);
